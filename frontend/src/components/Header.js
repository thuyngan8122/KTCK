          ...
          <div className="pc-header">
            <div className="row">
              <div className="col-md-3 col-4 d-flex align-items-center mb-4">
                <Link className="navbar-brand" to="/">
                  <img alt="logo" src="https://png.pngtree.com/template/20191209/ourlarge/pngtree-phone-deal-point-logo-template-designs-phone-store-logo-designs-image_338974.jpg" />
                </Link>
              </div>
